...
private:
    ...
    int8_t    i2c_open(char *i2c_file_path);
    int       SID_via_mcp23017_reset(uint8_t i2c_dev, uint8_t ic_addr);
    int       SID_via_mcp23017_write(uint8_t i2c_dev, uint8_t ic_addr, uint8_t addr, uint8_t data);
    uint8_t   SID_via_mcp23017_read(uint8_t i2c_dev, uint8_t ic_addr, uint8_t addr);
    uint8_t   get_i2c_register(int file, unsigned char addr, unsigned char reg, uint8_t *val);
